...
for (const route of routes) {
  ...
  const schema = route.path === '/' ? { '@context': 'https://schema.org', '@type': 'LocalBusiness', name: 'ARKO Studio', url: site, description: route.description, logo: `${site}/favicon.png`, image, telephone: '+54 9 11 7649-8888', areaServed: ['Buenos Aires', 'CABA', 'Zona Norte'] } : { '@context': 'https://schema.org', '@type': route.path === '/portfolio' ? 'CollectionPage' : 'Service', name: route.h1, url, description: route.description, ...(route.path !== '/portfolio' && { provider: { '@type': 'LocalBusiness', name: 'ARKO Studio', url: site }, areaServed: ['Buenos Aires', 'CABA', 'Zona Norte'] }) };
