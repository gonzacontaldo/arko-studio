...
export default function DevelopersSection() {
  return (
    <section className="py-16 md:py-32 px-4 md:px-8 bg-on-surface text-surface">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-10 md:gap-20">
        <div className="w-full md:w-1/2">
          ...
          <h2 className="font-headline font-extrabold text-3xl sm:text-5xl text-locked mb-6 md:mb-8 leading-tight break-words">
