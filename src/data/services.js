export const services = {
  'fotografia-inmobiliaria': {
    ...
    icon: 'photo_camera',
    portfolioType: 'foto',
    heroImage: '/portfolio-web/Virazon/Portada.jpg',
    benefits: ['Tomas generales y detalles', 'Edición profesional', 'Material listo para publicar'],
  ...
  'video-inmobiliario': {
    ...
    icon: 'movie',
    portfolioType: 'video',
    heroImage: '/portfolio-web/Civis/Portada.jpg',
    benefits: ['Formato horizontal', 'Contenido vertical para redes', 'Edición y ritmo audiovisual'],
  ...
  'drone-inmobiliario': {
    ...
    icon: 'flight_takeoff',
    portfolioType: 'dron',
    heroImage: '/portfolio-web/Lote/Portada.jpg',
    benefits: ['Contexto de la ubicación', 'Escala del lote y exteriores', 'Integración con foto y video'],
  ...
  'tour-virtual-360': {
    ...
    icon: 'vrpano',
    portfolioType: 'tour',
    heroImage: '/portfolio-web/DuplexOlivos/Portada.jpg',
    benefits: ['Recorrido desde cualquier dispositivo', 'Lectura completa de los ambientes', 'Complemento para publicaciones'],
  ...
  'planos-2d': {
    ...
    icon: 'architecture',
    portfolioType: null,
    heroImage: 'https://static.tokkobroker.com/pictures/6811203_16941810600148600011027949836947230498386497061057409250758090562184505248578.jpg',
    benefits: ['Relevamiento del inmueble', 'Representación clara de ambientes', 'Archivo listo para publicaciones'],
